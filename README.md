...
Старый черновой URL `/guides/underfill-overfill/` не публикуется: его материал объединён с `/guides/spool-lip-gap/`. Он отсутствует в sitemap и навигации; при прямом запросе GitHub Pages должен отдавать обычный 404. Если когда-либо появится необходимость сохранять внешний вес этого URL, серверный 301 можно добавить на уровне хостинга/прокси.
